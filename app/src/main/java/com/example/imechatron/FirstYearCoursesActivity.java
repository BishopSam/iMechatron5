...
public class FirstYearCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        firsthList.add(new Firsth(R.drawable.firsth3));
        firsthList.add(new Firsth(R.drawable.firsts));
